...
st.write("-->Price Model Trained Successfullyyyyy!")
...
def recommend_crop_with_profit(input_features):
    ...
    expected_revenue = 0.01 * predicted_yield * predicted_price  # bcoz it is per 100 acres
...
if st.button("Get Recommendation"):
    ...
    st.write(f"Expected Revenue per Acre: {revenue} Rs")
